...
<head>
    ...
    <!-- Title Page-->
    <title>CEDUPAZ - COOL ADMIN</title>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        @foreach ($docente->getCursosPadre() as $curso_padre)
                            <li>
                                <a class="js-arrow" href="#"><i class="fa fa-folder-open-o"></i>{{ucwords(strtolower($curso_padre->nombre))}}</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">

                                    @foreach ($curso_padre->hijos as $curso_hijo)
                                     <li>
                                        <a href="{{ route('persona/listar_materias_curso', $curso_hijo->id_curso) }}">{{$curso_hijo->nombre}}</a>
                                     </li>
                                     @endforeach
                                </ul>
                            </li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fa fa-group" ></i>Mis Cursos</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    @foreach ($docente->getCursosPadre() as $curso_padre)
                                        <li>
                                            <a class="js-arrow" href="#"><i class="fa fa-folder"></i>{{ucwords(strtolower($curso_padre->nombre))}}</a>
                                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{$docente->nombre}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{$docente->nombre}} {{$docente->apellido}}</a>
                                                    </h5>
                                                    <span class="email">{{$docente->email}}</span>
                                                </div>
                                            </div>
