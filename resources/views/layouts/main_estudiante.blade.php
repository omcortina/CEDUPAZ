...
@php
    $estudiante = \App\Persona::find(session('id_usuario'));
@endphp
<html lang="en">
    ...
    <div class="page-wrapper">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        @foreach ($estudiante->GetMateriasEstudiante() as $asignatura)
                            <li>
                                <a class="js-arrow" href="{{ route('asignatura/listar_documentos_materias', $asignatura->id_asignatura) }}"><i class="fa fa-book"></i>{{ucwords(strtolower($asignatura->nombre))}} </a>
                            </li>
                        @endforeach 
                    </ul>
                </div>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar" style="padding: 20px">
                    <ul class="list-unstyled navbar__list">
                        <li>
                                <p><b>{{ucwords(strtolower($estudiante->cursoActual()->nombre))}}</b></p>
                                <hr>
                            </li>
                        @foreach ($estudiante->GetMateriasEstudiante() as $asignatura)
                            <li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">{{$estudiante->nombre}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{$estudiante->nombre}} {{$estudiante->apellido}}</a>
                                                    </h5>
